...
public class BusquedaAutor extends JPanel {
	...
	public BusquedaAutor(JPanel contentPane, CardLayout cardLayout) {
		...
		lblNewLabel_11.setIcon(new ImageIcon(BusquedaAutor.class.getResource("/media/luparesized.png")));
		...
		JLabel lblNewLabel_7 = new JLabel("Búsqueda por autor");
		...
		lblNewLabel_32.setIcon(new ImageIcon(BusquedaAutor.class.getResource("/media/agregar-usuario (1).png")));
